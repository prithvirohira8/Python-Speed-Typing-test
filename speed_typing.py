...
print("\n\n")
lst_of_paragraphs = ["Python is a fantastic programming language","Java is an object oriented programming language","C++ has the fastest execution time for any program","Python is the most popular language"] 
